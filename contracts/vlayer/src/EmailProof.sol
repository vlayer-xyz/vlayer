...
import {IVDnsKeyRepository} from "./Repository.sol";
...
IVDnsKeyRepository constant DNS_REPOSITORY = IVDnsKeyRepository(address(0x916B850652b5B03Aa21709321c5f80A9E306BEcd));
