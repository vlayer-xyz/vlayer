...
library TestnetStableDeployment {
    ...
    function verifiers() internal pure returns (FakeProofVerifier, Groth16ProofVerifier, ProofVerifierRouter) {
        FakeProofVerifier fakeProofVerifier = FakeProofVerifier(address(0x1A1649F5F5F8C439c43455C16375e84A44E3Cb70));
        ...
        ProofVerifierRouter proofVerifierRouter =
            ProofVerifierRouter(address(0x8d3ca8D1953C3E377F7A731cd563a2B30B0BD359));
