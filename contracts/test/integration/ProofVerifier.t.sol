...
contract PinnedProofVerifer_Tests is Test {
    function setUp() public {
        ...
        vm.setBlockhash(
            ProofFixtures.FIXED_SETTLE_BLOCK_NUMBER,
            ProofFixtures.FIXED_SETTLE_BLOCK_HASH
        );
    }

    function test_canVerifyFakeProof() public {
        IProofVerifier verifier = new FakeProofVerifierUnderTest();
        (Proof memory proof, bytes32 journalHash) = ProofFixtures
            .fakeProofFixture();

        verifier.verify(
            proof,
            journalHash,
            ProofFixtures.FIXED_PROVER_ADDRESS,
            ProofFixtures.FIXED_SELECTOR
        );
    }
...
library ProofFixtures {
    bytes32 public constant FIXED_CALL_GUEST_ID =
        bytes32(
            0x17ae5657e365f3fb62f21ca9f8970452d3441ddaab415758e644bbd1587cd4da
        );
    address public constant FIXED_PROVER_ADDRESS =
    ...
    bytes32 public constant FIXED_SETTLE_BLOCK_HASH =
        bytes32(
            0xcf196c6f636905301b1a44c84c380d289c71ef599c410bfa24d69ab03396adbe
        );
    ...
    function fakeProofFixture() public pure returns (Proof memory, bytes32) {
        bytes32[8] memory sealBytes = [
            bytes32(
                0x933bd838d9a07b3b1ccc004c70e63711cd43c3e234de21bd105708b1b6922a52
            ),
            bytes32(
    ...
    function groth16ProofFixture() public pure returns (Proof memory, bytes32) {
        bytes32[8] memory sealBytes = [
            bytes32(
                0x0a703c1ac15f758ab379b36e692407a972797639b11326ecc32188b431080fb1
            ),
            bytes32(
                0x27b0d99a9b52f6b0d64e193ed914867d967969d402170d17e73d91c2e7caeec5
            ),
            bytes32(
                0x1f35d94edd6b0b09d74fcf47896c9f32c82f90180c136fe8d3be55ffcc7a1a1f
            ),
            bytes32(
                0x13d5392f503062abad4887291d8876cf0d948239d65b7c2e4c07d9802e697cb2
            ),
            bytes32(
                0x301c64d92932c40b13746d80a11996d49ed8f29095c1839f777b19ed670f45bb
            ),
            bytes32(
                0x1c60b428f2c95cb58c7045dcec3a89fdb230a53c79f4a2a558025b3ba1fdf365
            ),
            bytes32(
                0x03dd6a6f0595c24a44ef31a2b223afab6aa04556dee52af7c968d1b8981e8c92
            ),
            bytes32(
                0x250cc2acb7e6d3a3d0360b91e3f84158f3c43e44012bd3cf164a1ad099d23f53
            )
        ];

        Seal memory seal = Seal(
            Groth16VerifierSelector.STABLE_VERIFIER_SELECTOR,
            sealBytes,
            ProofMode.GROTH16
        );
    ...
    function generateProof(
        Seal memory seal
    ) private pure returns (Proof memory, bytes32) {
