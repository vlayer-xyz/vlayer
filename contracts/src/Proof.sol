...
library ProofLib {
    ...
    uint256 public constant COMMITMENT_OFFSET = LENGTH_LEN + SealLib.SEAL_ENCODING_LENGTH + DYNAMIC_PARAMS_OFFSETS_LEN;

    uint256 public constant PROOF_ENCODING_LENGTH = LENGTH_LEN + SealLib.SEAL_ENCODING_LENGTH
        + DYNAMIC_PARAMS_OFFSETS_LEN + ExecutionCommitmentLib.EXECUTION_COMMITMENT_ENCODING_LENGTH;
}
