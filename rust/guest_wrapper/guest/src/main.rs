...
use vlayer_steel::{config::ETH_SEPOLIA_CHAIN_SPEC, ethereum::EthEvmInput, Contract, contract::new_evm, contract::db::WrapStateDb};  
...
fn main() {
    ...
    let returns = Contract::new(CONTRACT, &env).call_builder(&call).call(evm);
