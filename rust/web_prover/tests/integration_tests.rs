...
mod integration_tests {
    ...
    async fn test_full_roundtrip() {
        ...
        assert_eq!(verification_result.key, "037b48f19c139b6888fb5e383a4d72c2335186fd5858e7ae743ab4bf8e071b06e7");
    }

    fn to_presentation(web_proof_result: &Result<String, Box<dyn Error>>) -> Presentation {
        bincode::deserialize(&hex::decode(web_proof_result.as_ref().unwrap()).unwrap()).unwrap()
    }
}
