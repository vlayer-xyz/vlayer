...
use crate::config::{DEFAULT_CALLER, OPTIMISM_SEQUENCER_VAULT, XYZ, XYZ1, XYZ2};

static EMPTY_ACCOUNTS: &[Address] = &[DEFAULT_CALLER, OPTIMISM_SEQUENCER_VAULT, XYZ, XYZ1, XYZ2];
