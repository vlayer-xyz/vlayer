...
const MOCK_PROOF: Bytes = bytes!("");
...
mod tests {
    ...
    mod two_consecutive_block_hashes {
        ...
        const MOCK_RISC0_CHAIN_GUEST_ID: [u32; 8] = [
            2663174293, 2024089015, 3465834372, 887420448, 2606376422, 1669533029, 1010997213,
            2366700158,
        ];
        ...
        async fn proof_does_verify() -> Result<()> {
            ...
            assert!(receipt.verify(MOCK_RISC0_CHAIN_GUEST_ID).is_ok());
