...
const [prover, verifier] = await testHelpers.deployProverVerifier(simpleTravelProver, simpleTravelVerifier);
...
await testHelpers.writeContract(verifier, simpleTravelVerifier.abi, 'verify', [proof, returnValue]);
