import { testHelpers, createVlayerClient, Branded } from "@vlayer/sdk";
...
const result = await vlayer.waitForProvingResult({ hash } as Branded<
  { hash: string },
  [typeof SimpleProver.abi, "balance"]
>);
