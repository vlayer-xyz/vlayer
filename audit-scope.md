...
│   │   ├── src
│   │   │   └── vlayer
│   │   │       ├── EmailDomainProver.sol
│   │   │       └── EmailProofVerifier.sol
│   │   ├── test
│   │   │   └── vlayer
│   │   │       └── EmailDomainProver.t.sol
│   │   ├── testdata
│   │   │   ├── incorrect_vlayer.eml
│   │   │   └── verify_vlayer.eml
│   │   └── vlayer
│   │       ├── README.md
│   │       ├── bun.lockb
...
│   │   │       ├── L2State.sol
│   │   │       ├── MockERC20.sol
│   │   │       ├── SimpleTeleportProver.sol
│   │   │       ├── SimpleTeleportVerifier.sol
│   │   │       └── WhaleBadgeNFT.sol
│   │   └── vlayer
│   │       ├── README.md
│   │       ├── bun.lockb
...
│   │   ├── test
│   │   │   └── vlayer
│   │   │       └── WebProofProver.t.sol
│   │   ├── testdata
│   │   │   ├── bad_web_proof_signature.json
│   │   │   └── web_proof.json
│   │   └── vlayer
│   │       ├── bun.lockb
│   │       ├── deploy.ts
...
│   │       │   │   └── WelcomeScreen.tsx
│   │       │   ├── containers
│   │       │   │   ├── MintingContainer.tsx
│   │       │   │   ├── ProvingContainer.tsx
│   │       │   │   ├── SimpleWebProofApp.tsx
│   │       │   │   └── WalletContainer.tsx
│   │       │   ├── hooks
│   │       │   │   └── useSimpleWebProof.ts
│   │       │   ├── main.css
│   │       │   ├── main.tsx
│   │       │   ├── prove.ts
│   │       │   ├── typescript.svg
