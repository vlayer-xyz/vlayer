...
## Generating and proving a web proof
...
The Web Proof feature is based on the [TLSNotary](https://tlsnotary.org/) protocol. To learn more details, please see the [Web Proof section](../features/web.md).
...
Vlayer is planning to provide additional Web Proof provider implementations, which can be e.g. ran server-side and don't require vlayer browser extension for the purpose of Web Proof generation.
