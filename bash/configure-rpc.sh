...
# Export variables for subsequent GitHub Actions steps
# GITHUB_ENV is automatically provided in GitHub Actions

echo "QUICKNODE_ENDPOINT=dry-alpha-tab" >> "$GITHUB_ENV"
echo "QUICKNODE_API_KEY=$QK_KEY"    >> "$GITHUB_ENV"
echo "JSON_RPC_URL=https://dry-alpha-tab.${FRAGMENT}.quiknode.pro/$QK_KEY" >> "$GITHUB_ENV"
