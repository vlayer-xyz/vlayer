import { MessageTranscript, toUtf8Transcript, Utf8String } from "./utils";
...
export const XAPICallTranscript = toUtf8Transcript(XAPICallTranscriptTlsn);
